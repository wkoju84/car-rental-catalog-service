...
* The original package name 'com.william.vehicle-catalog-emprescar' is invalid and this project uses 'com.william.vehicle_catalog_emprescar' instead.
...
* [Prometheus](https://docs.spring.io/spring-boot/3.5.16/reference/actuator/metrics.html#actuator.metrics.export.prometheus)
